...
const TARGETS = [
  ...
  { file: "plakietka-lada.html", out: "plakietka-lada.png", width: 559, height: 794 },
];
...
for (const t of TARGETS) {
  ...
  await page.screenshot({ path: resolve(OUT, t.out), fullPage: t.file.startsWith("ulotka") || t.file.startsWith("plak") });
  await page.close();
